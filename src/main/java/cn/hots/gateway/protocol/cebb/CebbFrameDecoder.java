 ...
 */
@Slf4j
public class CebbFrameDecoder extends ByteToMessageDecoder {
    ...
    protected void decode(ChannelHandlerContext ctx, ByteBuf in, List<Object> out) {
        try {
            ...
            String header = in.readCharSequence(16, StandardCharsets.UTF_8).toString();
            int bodyLength = Integer.parseInt(header.trim().substring(12));
